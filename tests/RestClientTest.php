...
class RestClientTest extends TestCase
{
    ...
    public function test_get()
    {
        ...
        $this->assertEquals(
            "foo=+bar&baz=1&bat%5B%5D=foo&bat%5B%5D=bar",
    ...
    public function test_build_indexed_queries()
    {
        ...
        $response_json = $result->decode_response();
        $this->assertEquals(
            "foo=+bar&baz=1&bat%5B0%5D=foo&bat%5B1%5D=bar&bat%5B2%5D=baz%5B12%5D",
            $response_json->SERVER->QUERY_STRING
        );
    }
    ...
    public function test_build_non_indexed_queries()
    {
        ...
        $response_json = $result->decode_response();
        $this->assertEquals(
            "foo=+bar&baz=1&bat%5B%5D=foo&bat%5B%5D=bar&bat%5B%5D=baz%5B12%5D",
            $response_json->SERVER->QUERY_STRING
        );
    }
}
